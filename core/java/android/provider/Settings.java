...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
       ...
       /**
        ...
        /**
         * Threshold below which network traffic would be hidden (in kB/s)
         * @hide
         */
         ...
         * 0 = Display in bits per second
         * 1 = Display in bytes per second
         * @hide
         */
        public static final String NETWORK_TRAFFIC_UNITS = "network_traffic_units";

        /**
         * Specify refresh duration for network traffic in seconds
         * @hide
         */
